          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <ScrollReveal delay={100}>
              <div className="bg-[#050505] p-10 rounded-[40px] text-white relative overflow-hidden group">
                <Globe className="absolute -right-12 -bottom-12 w-48 h-48 text-white/5 group-hover:scale-110 transition-transform duration-700 pointer-events-none" />
                ...
                <div className="flex items-center gap-2 text-blue-400 font-bold text-sm relative z-10 cursor-pointer">
                  <span>View Coverage</span> <ArrowRight size={16} />
                </div>
              </div>
            </ScrollReveal>
          </div>

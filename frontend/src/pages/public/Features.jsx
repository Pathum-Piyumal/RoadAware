      ...
      <section className="max-w-7xl mx-auto px-6 -mt-20 relative z-20">
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, idx) => {
            ...
            return (
              <div key={idx} className="group bg-white rounded-[32px] p-10 border border-gray-100 shadow-xl shadow-gray-200/30 hover:shadow-2xl hover:border-blue-200/50 transition-all duration-500 flex flex-col items-start relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            {[
              ...
              <div key={idx} className="bg-white rounded-3xl p-8 border border-slate-100 shadow-xl shadow-slate-100/20 flex flex-col items-center text-center hover:shadow-2xl transition-all duration-300 group">
                ...
                <span className="text-xs font-bold text-blue-600 mb-2">{item.step}</span>

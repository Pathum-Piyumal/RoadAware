    ...
    <AuthLayout 
      ...
      subtitle={
        <div className="text-gray-300">
          Already a member?{' '}
          <Link to="/login" className="font-semibold text-white hover:text-cyan-300 underline underline-offset-4">
            Sign in
          </Link>
        </div>
      }
      footer={
        <span className="text-gray-400">By continuing you agree to RoadAware terms and privacy policy.</span>
      }
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="pt-2">
          ...
          >
            {isLoading ? <Loader2 className="animate-spin h-5 w-5" /> : <>Get started <ArrowRight size={16} className="ml-2" /></>}
          </button>
        </div>
      </form>
    </AuthLayout>
